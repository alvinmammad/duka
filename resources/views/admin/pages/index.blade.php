        ...
        <div class="row">
            ...
            <div class="col-xl-6 custome-width">
                <div class="card">
                    ...
                    <div class="card-body ">
                        <p style="width:90%;">Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem
                            ipsum dolor sit amet, consectetur adipiscing elit.dolor sit amet, consectetur
                            adipiscing elit</p>
                        <div class="row">
                            <div class="col-xl-6">
                                <div id="piechart"></div>
            ...
            <div class="col-xl-3">
                <div class="card">
                    ...
                    <div class="card-footer pt-0 border-0">
                        ...
                        <a href="app-profile-2.html" class="text-primary font-w600 text-center d-block">View
                            More</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                        ...
                        <ul class="revnue-tab-1 nav nav-tabs ms-auto me-3" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="categories-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="categories-tab-pane" aria-selected="true">All
                                    Categories</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="breakfast-tab" data-bs-toggle="tab"
                                    data-bs-target="#breakfast-tab-pane" type="button" role="tab"
                                    aria-controls="breakfast-tab-pane" aria-selected="false">Breakfast
                                    Menus</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="menus-tab" data-bs-toggle="tab"
                                    data-bs-target="#menus-tab-pane" type="button" role="tab"
                                    aria-controls="menus-tab-pane" aria-selected="false">Lunch Menus</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="dinner-tab" data-bs-toggle="tab"
                                    data-bs-target="#dinner-tab-pane" type="button" role="tab"
                                    aria-controls="dinner-tab-pane" aria-selected="false">Dinner Menus</button>
                            </li>
                        </ul>
                        <div>
                            <select class="default-select h-select" aria-label="Default select example">
                    ...
                    <div class="card-body pt-0">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="categories-tab-pane" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-xl-8 col-md-7 col-sm-6">
                                        <div class="fav-box">
                                            <div class="fav-media"
                                                style="background-image: url({{ asset('assets/images/favirate-img/1.png);') }}">
                                                <ul class="dz-badge-list">
                                                    <li>
                                                        <a href="javascript:void(0);"
                                                            class="badge badge-warning badge-sm"><svg width="13"
                                                                height="13" viewBox="0 0 13 13" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M12.9252 4.92282C12.8549 4.71309 12.6729 4.56048 12.4541 4.52772L8.69635 3.95363L7.01 0.361883C6.91293 0.155386 6.7053 0.0235596 6.47712 0.0235596C6.24895 0.0235596 6.04132 0.155386 5.94425 0.361883L4.25789 3.95363L0.500099 4.52772C0.281881 4.56099 0.100597 4.71351 0.0304959 4.92282C-0.0396053 5.13213 0.0132523 5.36307 0.16742 5.52105L2.90598 8.32497L2.25829 12.2924C2.22223 12.5145 2.31595 12.7378 2.49977 12.8676C2.68358 12.9975 2.92534 13.0112 3.12266 12.903L6.47889 11.0494L9.83511 12.903C10.0324 13.0121 10.2748 12.999 10.4592 12.8691C10.6435 12.7393 10.7376 12.5155 10.7013 12.293L10.0536 8.32556L12.7904 5.52105C12.9438 5.36263 12.9958 5.13174 12.9252 4.92282Z"
                                                                    fill="white" />
                                                ...
                                                <ul class="dz-info-list">
                                                    <li>
                                                        <a href="ecom-product-detail.html"
                                                            class="title font-w700 text-white">Spaghetti
                                                            Italiano With Mozarella Cheese</a>
                                                    ...
                                                    <ul
                                                        ...
                                                        <li class="text-success"><svg width="16" height="17"
                                                                ...
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M7.59326 0.906738C3.39962 0.906738 0 4.30636 0 8.5C0 12.6936 3.39962 16.0933 7.59326 16.0933C11.7869 16.0933 15.1865 12.6936 15.1865 8.5C15.1816 4.30841 11.7849 0.911682 7.59326 0.906738ZM7.59326 14.7127C4.1621 14.7127 1.38059 11.9312 1.38059 8.5C1.38059 5.06884 4.1621 2.28733 7.59326 2.28733C11.0244 2.28733 13.8059 5.06884 13.8059 8.5C13.8021 11.9296 11.0228 14.7089 7.59326 14.7127Z"
                                                                    fill="#3CD860" />
                                                                <path
                                                                    d="M10.5781 6.26546L6.92368 9.61547L5.32012 8.01191C5.05062 7.74226 4.61355 7.74226 4.34397 8.01184C4.07439 8.28142 4.07439 8.71849 4.34397 8.98807L6.41493 11.0589C6.67629 11.3203 7.09717 11.3294 7.36961 11.0796L11.5114 7.28296C11.7924 7.02524 11.8112 6.58855 11.5535 6.30757C11.2958 6.0266 10.8591 6.00775 10.5781 6.26546Z"
                                                                    fill="#3CD860" />
                                                            </svg>
                                                            456 Served
                                                        </li>
                                                        <li>
                                                            <h3 class="text-white mb-0">$95</h3>
                                                        </li>
                                                    </ul>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-md-5 col-sm-6">
                                        <div class="fav-box">
                                            <div class="fav-media"
                                                style="background-image: url({{ asset('assets/images/favirate-img/2.png);') }}">
                                                <ul class="dz-badge-list">
                                                    <li>
                                                        <a href="javascript:void(0);"
                                                            class="badge badge-warning badge-sm"><svg width="13"
                                                ...
                                                <ul class="dz-info-list">
                                                    <li>
                                                        <a href="ecom-product-detail.html"
                                                            class="title font-w700 text-white">Baked Bread with
                                                            Ice Cream</a>
                                                        <p class="text-white mt-2">Lorem ipsum dolor sit amet,
                            ...
                            <div class="tab-pane fade" id="breakfast-tab-pane" role="tabpanel"
